package com.flashmedia.basics.actions.intervalactions
{
	...
	public class Animation extends IntervalAction
	{
		...
		public function start(iterationsCount: int = 1, startFrame: int = -1, endFrame: int = -1): void {
			...
			super._startIntervalAction(iterationsCount);
		}
		
		public function pause(): void {
			super._pauseIntervalAction();
		}
		
		public function stop(): void {
			super._stopIntervalAction();
			_curFrame = _startFrame;
			changeFrame();
		}
